...
def define_constants():
    """
    Translation of src/IO/define_constants.m
    Defines physical constants used in the SCOPE model.
    """
    const = {}
    ...
    const['deg2rad'] = np.pi / 180  # [rad/deg] From degrees to radians
    const['C2K'] = 273.15       # [K]           Melting point of water
    # Note: deg2rad is repeated, but we keep the assignment once for the value.
